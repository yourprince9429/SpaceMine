...
项目完全参考网站 https://ccyzz.com/ui/ ，账号find12138， 密码Lovexzc94228
页面结构及内容也均与该网站完全一致，如有页面描述不清楚的，可以自行查看该网站页面元素、逻辑、风格等
以后说参考网站就是指这个网站
...
```shell
curl -c cookies.txt -X POST https://ccyzz.com/api/login -H "Content-Type: application/json" -d '{"username":"find12138","password":"927ad37e9a2f03b7c01c02b99339489299c36576096b37ee2e62d5292564a957","nonce":"955afeabddfcf5187a8db0482a3af8fb","ts":1769400632630}'
```

- 成功后设置X-Session-Token cookie访问后续页面
例如
```shell
curl -b "X-Session-Token=cb2b951c69992d4f2fa2e74b7844aa0894dbfe1aaa8492601777b509bbecb988" https://ccyzz.com/ui/
```
